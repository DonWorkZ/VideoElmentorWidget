...
namespace ElementorVideoWidget\PageSettings;
...
class Page_Settings
{
    ...
    {
        Controls_Manager::add_tab(self::PANEL_TAB, __('New Tab', 'elementor-video-widget'));
    }
    ...
    public function register_document_controls($document)
    {
        ...
        $document->start_controls_section(
            'new_section',
            [
                'label' => __('Settings', 'elementor-video-widget'),
                'tab' => self::PANEL_TAB,
            ]
        );
