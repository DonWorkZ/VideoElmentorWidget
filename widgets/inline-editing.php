...
class Inline_Editing extends Widget_Base
{
    ...
    {
        return __('Inline Editing', 'elementor-video-widget');
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            'section_content',
            [
                'label' => __('Content', 'elementor-video-widget'),
            ]
        );
        ...
        $this->add_control(
            'title',
            [
                'label' => __('Title', 'elementor-video-widget'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Title', 'elementor-video-widget'),
            ]
        );
        ...
        $this->add_control(
            'description',
            [
                'label' => __('Description', 'elementor-video-widget'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('Description', 'elementor-video-widget'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Content', 'elementor-video-widget'),
            ]
        );
